        ...
        <div class="project-header__grid">
          <div class="project-header__content">
            ...
            <div class="project-links">
              <AppButton v-if="project.githubUrl" :to="project.githubUrl" target="_blank" variant="primary">
              ...
              <AppButton v-if="project.liveUrl" :to="project.liveUrl" target="_blank" :variant="project.githubUrl ? 'secondary' : 'primary'">
